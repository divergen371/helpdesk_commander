...
config :helpdesk_commander, HelpdeskCommanderWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: HelpdeskCommanderWeb.ErrorHTML, json: HelpdeskCommanderWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: HelpdeskCommander.PubSub,
  live_view: [signing_salt: "Ue6MDLbd"]
...
config :helpdesk_commander, HelpdeskCommander.Mailer, adapter: Swoosh.Adapters.Local
