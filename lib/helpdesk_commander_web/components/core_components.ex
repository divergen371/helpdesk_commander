defmodule HelpdeskCommanderWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: HelpdeskCommanderWeb.Gettext
  ...
  def icon(%{name: "hero-" <> _heroicon_name} = assigns) do
    ~H"""
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HelpdeskCommanderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HelpdeskCommanderWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  """
  @spec translate_errors(keyword({String.t(), Keyword.t()}), atom()) :: [String.t()]
